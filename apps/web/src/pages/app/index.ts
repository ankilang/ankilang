/**
 * Index des pages de l'application
 * Export de toutes les pages de l'application principale (protégées)
 */

export { default as Dashboard } from './Dashboard'
export { default as ThemesIndex } from './themes/Index'
export { default as NewTheme } from './themes/New'
